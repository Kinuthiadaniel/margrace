    ...
    <div className=" px-4 sm:px-6 lg:px-8 bg-blue-400">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
            <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
              <div>
              <img src="" alt="Company Logo" className="object-cover object-center w-40 h-20" />
              </div>
             
                <p className="py-8 text-sm text-white lg:max-w-xs text-center lg:text-left">24/7 Supply of water</p>
            </div>
        ...
        <div className="py-7 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                <span className="text-sm text-white ">©<a href="https://pagedone.io/">Margrace</a> 2024, All rights reserved.</span>
